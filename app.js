...
async function getAllTodos() {
    const res = await fetch('https://jsonplaceholder.typicode.com/todos?_limit=18');
...
function todoToHTML({id, completed, title}){
    ...
    todoList.insertAdjacentHTML('beforeend', `
        <div class="form-check" id="todo${id}">
            ...
            <button onclick="deleteTodo(${id})" type="button" class="btn-close" arial-label="Close" style="font-size: 10px">
